...
This calculation was outlined in detail in Section “Using wmST as an oxybarometer” in `Hughes et al. (2023) <https://doi.org/10.1144/jgs2021-125>`_ (schematic in figure below, H`Hughes et al. (pre-print) <https://doi.org/10.31223/X52X3G>`_).

.. figure:: figures/SfO2calc.png

In these examples we'll show you how to run this calculation for:
