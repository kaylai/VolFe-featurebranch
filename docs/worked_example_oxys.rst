...
This calculation was outlined in detail in Section “Using *w*\ :sup:`m` \ :sub:`ST` as an oxybarometer” in `Hughes et al. (2023) <https://doi.org/10.1144/jgs2021-125>`_ (schematic of the calculation shown in the figure below; `Hughes et al., pre-print <https://doi.org/10.31223/X52X3G>`_).
