...
class MeltComposition:
    ...
    def __init__(self, melt_fraction, choice):
        ...
        if choice == 1:
            ...
            sio2 = 43.97/ melt_fraction
            al2o3 = 19.09/ melt_fraction
            feot = 9.36/ melt_fraction
            mgo = 6.76/ melt_fraction
            cao = 13.28 / melt_fraction
            na2o = 1.46/ melt_fraction
            k2o = 0.37 / melt_fraction
            p2o5 = 0.11/ melt_fraction
            mno = 0.22 / melt_fraction
            tio2 = 0.7/ melt_fraction
